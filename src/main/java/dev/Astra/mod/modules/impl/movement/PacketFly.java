...
public class PacketFly extends Module {
    ...
    public final SliderSetting invalidY = this.add(new SliderSetting("Invalid-Offset", 1337, 0, 1337).setSuffix("m"));
    ...
    public final SliderSetting concealY = this.add(new SliderSetting("C-Y", 0.0, -256.0, 256.0).setSuffix("m"));
