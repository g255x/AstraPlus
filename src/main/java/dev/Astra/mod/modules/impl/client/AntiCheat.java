...
import dev.Astra.mod.modules.settings.enums.Placement;
import dev.Astra.mod.modules.settings.enums.SnapBack;
...
public class AntiCheat extends Module {
    ...
    public final BooleanSetting movementSync = this.add(new BooleanSetting("MovementSync", true, () -> this.page.is(Page.General)));
    public final BooleanSetting noBadSlot = this.add(new BooleanSetting("NoBadSlot", false, () -> this.page.is(Page.General)));
    public final SliderSetting ieRange = this.add(new SliderSetting("InteractEntityRange", 3.0, 0.0, 8.0, 0.1, () -> this.page.is(Page.General)).setSuffix("m"));
    ...
    public final SliderSetting rotateTime = this.add(new SliderSetting("LookTime", 0.5, 0.0, 1.0, 0.01, () -> this.page.is(Page.Rotation)).setSuffix("s"));
    ...
    public final SliderSetting doubleMineTimeout = this.add(new SliderSetting("DoubleTimeout", 2.0, 0.0, 3.0, 0.1, () -> this.page.is(Page.Misc)).setSuffix("s"));
    ...
    public final SliderSetting breakTimeout = this.add(new SliderSetting("BreakFailed", 1.5, 0.0, 3.0, 0.1, () -> this.page.is(Page.Misc)).setSuffix("s"));
