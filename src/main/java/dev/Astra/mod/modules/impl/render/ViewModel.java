...
import dev.Astra.api.events.impl.HeldItemRendererEvent;
import dev.Astra.asm.accessors.IHeldItemRenderer;
...
public class ViewModel
    ...
    public final SliderSetting eatShakeMultiplier = this.add(new SliderSetting("EatShakeMultiplier", 0.1, 0.0, 2.0, 0.01));
