...
public class AutoCrystal extends Module {
    ...
    public void onThread() {
        if (this.isOff() || AutoCrystal.nullCheck() || mc.world == null) return;
    ...
    private boolean shouldReturn() {
        if (this.usingPause.getValue() && mc.player.isUsingItem() || Blink.INSTANCE.isOn() && Blink.INSTANCE.pauseModule.getValue()) {
            this.lastBreakTimer.reset();
            return true;
        }
